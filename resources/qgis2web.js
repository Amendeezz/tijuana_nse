...
map.getView().fit([-13043743.037350, 3794162.328237, -12979309.041671, 3845787.327000], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">NIVELES SOCIOECONOMICOS EN TIJUANA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (85 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'ELABORACION: ALEJANDRO MENDEZ<br />FUENTE: SCINCE 202 CON BASE EN LA METODOLOGIA DEL AMAI.';
            }
